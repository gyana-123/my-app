 ...
 var l = location.state ;
  ...
  return (<>
    ...
    <div className="form-group col-md">
      ...
      <br></br>
  <div><button onClick={()=>addProduct()} className="btn btn-primary">Add Product</button></div>
   <div><button onClick={()=>updateProduct()} className="btn btn-primary">Update Product</button></div>
